...
'''
#transport scattering coefficient   μs(λ) = a(λ/500 nm)^−b @ (Jacques 2013)
a_forearm=18.9
b_forearm=1.286
µs_forearm_690=a_forearm*(lambda_1/500)**(-b_forearm)
µs_forearm_780=a_forearm*(lambda_2/500)**(-b_forearm)
µs_forearm_810=a_forearm*(lambda_3/500)**(-b_forearm)
µs_forearm_850=a_forearm*(lambda_4/500)**(-b_forearm)
'''
...
df = pd.read_csv('Row-Voltage20221019-113649.csv')
...
data_voltages_raw=32768-data_voltages_raw
...
Sl_µs_forearm_690_780_810_850=(Sl_690_780_810_850**2)/(3*µs_forearm_690_780_810_850)  #µ_a_690_780_810_850
# µ_a   
...
Concentrationrawvoltagedata ="filter/Concentration_raw_voltage_data"+citation+".csv"#+ time.strftime("%Y%m%d-%H%M%S")
...
Abs_Concentration_690_780_810_850_HbO_HbR_CtOx_ICG=Abs_Concentration_690_780_810_850_HbO_HbR_CtOx_ICG.reshape(-1,48)
#%%
...
for i in range(0, subplot_row):
    for j in range(0, subplot_col):
        ...
        fs = 3       # sample rate, Hz
        cutoff = 0.2      # desired cutoff frequency of the filter, Hz ,      slightly higher than actual 1.2 Hz
...
fig.update_layout(width=1700,height=5000,title_text="Enable Pig 05",plot_bgcolor="rgb(256,256,256)")#,xaxis=dict(tickvals=xs/3))

plot(fig, filename="Raw_voltage.html")
fig.show()
fig.write_image("images/Raw_voltage.svg")
fig.write_html("html/Raw_voltage.html")


#%%the ploted filterd voltage data
LowpassfilteredVoltagedata ="filter/Lowpass_filtered_Voltage_data"+citation+".csv"#+ time.strftime("%Y%m%d-%H%M%S")
Lowpass_filtered_Voltage_data=Lowpass_filtered_Voltage_data[:,1:]
'''
with open(LowpassfilteredVoltagedata,'a') as csvfile:
    np.savetxt(csvfile, Lowpass_filtered_Voltage_data,delimiter=',',header='LED_1_PD_1,LED_1_PD_2,LED_1_PD_3,LED_1_PD_4,LED_1_PD_5,LED_1_PD_6,LED_1_PD_7,LED_1_PD_8,\
LED_2_PD_1,LED_2_PD_2,LED_2_PD_3,LED_2_PD_4,LED_2_PD_5,LED_2_PD_6,LED_2_PD_7,LED_2_PD_8,\
LED_3_PD_1,LED_3_PD_2,LED_3_PD_3,LED_3_PD_4,LED_3_PD_5,LED_3_PD_6,LED_3_PD_7,LED_3_PD_8,\
LED_4_PD_1,LED_4_PD_2,LED_4_PD_3,LED_4_PD_4,LED_4_PD_5,LED_4_PD_6,LED_4_PD_7,LED_4_PD_8,\
LED_5_PD_1,LED_5_PD_2,LED_5_PD_3,LED_5_PD_4,LED_5_PD_5,LED_5_PD_6,LED_5_PD_7,LED_5_PD_8,\
...
dfobj = pd.DataFrame(Lowpass_filtered_Voltage_data,columns = ['LED_1_PD_1','LED_1_PD_2','LED_1_PD_3','LED_1_PD_4','LED_1_PD_5','LED_1_PD_6','LED_1_PD_7','LED_1_PD_8','\
LED_2_PD_1','LED_2_PD_2','LED_2_PD_3','LED_2_PD_4','LED_2_PD_5','LED_2_PD_6','LED_2_PD_7','LED_2_PD_8','\
LED_3_PD_1','LED_3_PD_2','LED_3_PD_3','LED_3_PD_4','LED_3_PD_5','LED_3_PD_6','LED_3_PD_7','LED_3_PD_8','\
LED_4_PD_1','LED_4_PD_2','LED_4_PD_3','LED_4_PD_4','LED_4_PD_5','LED_4_PD_6','LED_4_PD_7','LED_4_PD_8','\
LED_5_PD_1','LED_5_PD_2','LED_5_PD_3','LED_5_PD_4','LED_5_PD_5','LED_5_PD_6','LED_5_PD_7','LED_5_PD_8','\
...
Lowpass_filtered_Voltage_data = pd.concat([df_2, dfobj], axis=1)
Lowpass_filtered_Voltage_data.to_csv(LowpassfilteredVoltagedata,index=False)   
                
'''
KalmanfilteredVoltagedata ="filter/Kalman_filtered_Voltage_data"+citation+".csv"#+ time.strftime("%Y%m%d-%H%M%S")            
kalman_filtered_Voltage_data=kalman_filtered_Voltage_data[:,1:]  
            
with open(KalmanfilteredVoltagedata,'a') as csvfile:
    np.savetxt(csvfile, kalman_filtered_Voltage_data,delimiter=',',header='LED_1_PD_1,LED_1_PD_2,LED_1_PD_3,LED_1_PD_4,LED_1_PD_5,LED_1_PD_6,LED_1_PD_7,LED_1_PD_8,\
LED_2_PD_1,LED_2_PD_2,LED_2_PD_3,LED_2_PD_4,LED_2_PD_5,LED_2_PD_6,LED_2_PD_7,LED_2_PD_8,\
LED_3_PD_1,LED_3_PD_2,LED_3_PD_3,LED_3_PD_4,LED_3_PD_5,LED_3_PD_6,LED_3_PD_7,LED_3_PD_8,\
LED_4_PD_1,LED_4_PD_2,LED_4_PD_3,LED_4_PD_4,LED_4_PD_5,LED_4_PD_6,LED_4_PD_7,LED_4_PD_8,\
LED_5_PD_1,LED_5_PD_2,LED_5_PD_3,LED_5_PD_4,LED_5_PD_5,LED_5_PD_6,LED_5_PD_7,LED_5_PD_8,\
...
dfobj = pd.DataFrame(kalman_filtered_Voltage_data,columns = ['LED_1_PD_1','LED_1_PD_2','LED_1_PD_3','LED_1_PD_4','LED_1_PD_5','LED_1_PD_6','LED_1_PD_7','LED_1_PD_8','\
LED_2_PD_1','LED_2_PD_2','LED_2_PD_3','LED_2_PD_4','LED_2_PD_5','LED_2_PD_6','LED_2_PD_7','LED_2_PD_8','\
LED_3_PD_1','LED_3_PD_2','LED_3_PD_3','LED_3_PD_4','LED_3_PD_5','LED_3_PD_6','LED_3_PD_7','LED_3_PD_8','\
LED_4_PD_1','LED_4_PD_2','LED_4_PD_3','LED_4_PD_4','LED_4_PD_5','LED_4_PD_6','LED_4_PD_7','LED_4_PD_8','\
LED_5_PD_1','LED_5_PD_2','LED_5_PD_3','LED_5_PD_4','LED_5_PD_5','LED_5_PD_6','LED_5_PD_7','LED_5_PD_8','\
...
kalman_filtered_Voltage_data = pd.concat([df_2, dfobj], axis=1)
kalman_filtered_Voltage_data.to_csv(KalmanfilteredVoltagedata,index=False)   '''